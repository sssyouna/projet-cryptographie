...
| GET | `/api/public` | ❌ | - | - | Endpoint public |
| GET | `/api/me` | ✅ | `profile` or `openid` | - | Infos utilisateur |
| GET | `/api/orders` | ✅ | `read:orders` | - | Liste des commandes |
| POST | `/api/orders` | ✅ | `write:orders` | - | Créer commande |
| GET | `/api/admin/stats` | ✅ | - | `admin` | Stats admin |
| GET | `/api/admin/users` | ✅ | `admin:read` | `admin` | Liste utilisateurs |
