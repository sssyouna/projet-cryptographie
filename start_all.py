...
def main():
    ...
    print("1. Starting Authorization Server (Omar)...")
    ...
    print("2. Starting Resource Server (Your API)...")
    ...
    print("3. Starting Frontend Server (Dashboard)...")
    ...
    print("   Resource Server:     http://localhost:5000")
